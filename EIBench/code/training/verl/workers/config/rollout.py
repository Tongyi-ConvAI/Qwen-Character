...
class RolloutConfig(BaseConfig):
    ...
    # Legacy compatibility field for rollout-side environment settings.
    # For simulator migration, this may contain:
    #   environment.name=simulator_v2_env
    #   environment.max_turns / per_turn_length / model_sim / base_url / simulator_batch_size
