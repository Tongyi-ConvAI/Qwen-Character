...
_ROLLOUT_REGISTRY = {
    ...
    # Legacy rollout names: keep old launch scripts usable during migration.
    ("vllm_multi_turn", "async"): "verl.workers.rollout.vllm_rollout.ServerAdapter",
    ("vllm_multi_turn_via_chat", "async"): "verl.workers.rollout.vllm_rollout.ServerAdapter",
    ("vllm_multi_turn_via_chat_think", "async"): "verl.workers.rollout.vllm_rollout.ServerAdapter",
