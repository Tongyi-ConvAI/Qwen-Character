...
def validate_config(
    ...
    # strip-think mode expands samples at runtime, so train_batch_size < ppo_mini_batch_size is valid
    env_name = ""
    try:
        env_name = str(config.actor_rollout_ref.rollout.environment.name or "")
    except Exception:
        pass
    is_strip_think = "no_think" in env_name or "strip_think" in env_name
    actor_config.validate(n_gpus, config.data.train_batch_size, config.actor_rollout_ref.model,
                          skip_batch_size_check=is_strip_think)
